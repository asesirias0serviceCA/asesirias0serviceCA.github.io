document.getElementById("contactForm").addEventListener("submit", function (event) {
    ...
    const currentPage = "Oferta de Microempresa"; // Título específico para esta sección                       // este es el apartado de emprendimient
    ...
    const templateParams = {
        ...
        message: message,
        page_info: `${name} solicita hablar contigo por la oferta de emprendimiento. 
            Mensaje: ${message} 
