document.getElementById("contactForm").addEventListener("submit", function (event) {
    ...
    // Creamos el objeto para enviar con los parámetros de EmailJS                                                      /// esta es la oferta de personalizado
    const templateParams = {
        from_name: name,
        from_email: email,
        message: message,
        from_phone: phone,
        page_info: `${name} solicita hablar contigo por la oferta de personalizado. 
        Mensaje: ${message} 
